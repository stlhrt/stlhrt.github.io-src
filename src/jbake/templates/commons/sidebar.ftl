...
<section id="sidebar">
    ...
    <!-- About -->
        ...
        <section id="footer">
            <p class="copyright">&copy; ${config.site_title}. Design: <a href="http://html5up.net" target="_blank">HTML5 UP</a>.
                Ported For SSG by <a href="https://github.com/jpescador/hugo-future-imperfect">Julio Pescador</a>.
                Adapted to JBake by <a href="https://github.com/manikmagar" target="_blank">Manik Magar</a>.
                Icon made by <a href="https://www.flaticon.com/authors/freepik" target="_blank">Freepik</a> from <a href="www.flaticon.com" target="_blank">www.flaticon.com</a>.
